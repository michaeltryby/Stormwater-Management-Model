...
BOOST_FIXTURE_TEST_CASE(test_getNodeResult, Fixture) {
    ...
    std::vector<float> ref_vec = {0.296234f,
                                 995.296204f,
                                 0.0f,
                                 1.302650f,
                                 1.302650f,
...
BOOST_FIXTURE_TEST_CASE(test_getLinkResult, Fixture) {
    ...
    std::vector<float> ref_vec = {4.631762f,
                                  1.0f,
                                  5.8973422f,
                                  314.15927f,
                                  1.0f,
...
BOOST_FIXTURE_TEST_CASE(test_getSystemResult, Fixture) {
    ...
    std::vector<float> ref_vec = {70.0f,
                                  0.1f,
                                  0.0f,
                                  0.19042271f,
                                  14.172027f,
