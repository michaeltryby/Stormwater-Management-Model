...
#
#  before-test.sh - Prepares linux worker to run swmm regression tests
#
#  Created:  04/05/2018
#  Modified: 12/19/2019
#
...
EXAMPLES_VER="1.1.0-dev"
#BENCHMARK_VER="5112"

TESTFILES_URL="https://github.com/michaeltryby/swmm-nrtestsuite/archive/v${EXAMPLES_VER}.tar.gz"
...
ln -s swmm-nrtestsuite-${EXAMPLES_VER}/public tests
